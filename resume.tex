...
\name{Mengqi (Menki)}{Chen}
% \position{Smart Contract Engineer{\enskip\cdotp\enskip}Full }
% \address{YOUR ADDRESS}


\email{tinkleidea@hotmail.com}
%\dateofbirth{May 22th, 1992}
\homepage{umiotter.com} 
\github{github.com/umiotter}
\linkedin{linkedin.com/in/chenmegnqi/}
% \gitlab{gitlab-id}
...
% \kaggle{kaggle-id}
%\mobile{+86 1313}
\googlescholar{9xrms30AAAAJ}{Google Scholar}
